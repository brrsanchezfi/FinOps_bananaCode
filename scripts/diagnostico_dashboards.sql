...
FROM finops.gold.fct_cost_forecast
UNION ALL SELECT 'fct_chargeback_monthly', COUNT(*), NULL, NULL
FROM finops.gold.fct_chargeback_monthly
ORDER BY tabla;
...
SHOW GRANTS ON SCHEMA finops.gold;
